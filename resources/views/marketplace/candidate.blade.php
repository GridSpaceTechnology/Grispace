...
<div class="py-8">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <a href="{{ route('marketplace.index') }}" class="text-brand-primary hover:text-brand-primary-hover flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 sticky top-24">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">Interested in hiring?</h2>
                    ...
                    <div class="space-y-3">
                        @auth
                            ...
                            @else
                                <p class="text-sm text-gray-500">Sign in as an employer to contact this candidate.</p>
                            @endif
                        @else
                            <a href="{{ route('login') }}" class="block w-full px-4 py-2 bg-brand-primary text-white text-center rounded-lg hover:bg-brand-primary-hover transition-colors">
                                Sign in to Contact
                            </a>
                            <p class="mt-2 text-sm text-gray-500 text-center">Don't have an account? <a href="{{ route('register') }}" class="text-brand-primary hover:underline">Register</a></p>
                        @endauth
                    </div>
                </div>
